...
License: GPL2
Copyright 2017 Raphael Heide (email : contact@raphaelheide.com)
...
class meuastroWidget extends WP_Widget
{
	...
	{
		parent::__construct('meuastroWidget', __('Horóscopo', 'meuastro' ), array ('description' => __( 'Este plugin mostra em seu site o Horóscopo diário atualizado em Português.', 'meuastro')));
	}
...
// Works on 8.0+
add_action( 'widgets_init', function() { return register_widget("meuastroWidget"); } );
